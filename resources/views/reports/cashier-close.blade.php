@extends('layouts.app', ['title' => 'Cuadre por despachador'])

@section('content')
<div class="bg-white rounded-xl shadow-sm border p-5">
    <h1 class="text-xl font-semibold mb-4">Cuadre por despachador</h1>
...
async function loadReport() {
  ...
  const res = await fetch(`/api/reports/cashier-close?date=${date}`, {
  ...
  if (!data.summary_by_user.length) {
    out.innerHTML = `<div class="text-gray-600">No hay ventas para la fecha seleccionada.</div>`;
    return;
  }
